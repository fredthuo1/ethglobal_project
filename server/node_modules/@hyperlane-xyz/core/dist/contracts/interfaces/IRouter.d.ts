...
export interface IRouterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "routers"): FunctionFragment;
...
export interface IRouter extends BaseContract {
    ...
    functions: {
        ...
        enrollRemoteRouters(_domains: BigNumberish[], _routers: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        enrollRemoteRouters(_domains: BigNumberish[], _routers: BytesLike[], overrides?: CallOverrides): Promise<void>;
        routers(_domain: BigNumberish, overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
    estimateGas: {
