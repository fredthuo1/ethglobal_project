...
export interface MockHyperlaneEnvironmentInterface extends utils.Interface {
    functions: {
        ...
        "queryRouters(uint32)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "igps" | "isms" | "mailboxes" | "processNextPendingMessage" | "processNextPendingMessageFromDestination" | "queryRouters"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "queryRouters", values: [BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "queryRouters", data: BytesLike): Result;
    events: {};
}
export interface MockHyperlaneEnvironment extends BaseContract {
    ...
    functions: {
        ...
        queryRouters(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    };
    igps(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
    isms(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
    mailboxes(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        queryRouters(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        queryRouters(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
