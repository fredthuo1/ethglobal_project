...
export interface OptimismMessageHookInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "destinationDomain" | "ism" | "l1Messenger" | "postDispatch"): FunctionFragment;
...
export interface OptimismMessageHook extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: OptimismMessageHookInterface;
    ...
    functions: {
        ...
        postDispatch(_destination: BigNumberish, _messageId: BytesLike, overrides?: PayableOverrides & {
    ...
    callStatic: {
        ...
        ism(overrides?: CallOverrides): Promise<string>;
        l1Messenger(overrides?: CallOverrides): Promise<string>;
        postDispatch(_destination: BigNumberish, _messageId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {};
    estimateGas: {
...
//# sourceMappingURL=OptimismMessageHook.d.ts.map