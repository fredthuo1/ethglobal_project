...
export interface ICircleMessageTransmitterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "receiveMessage" | "usedNonces"): FunctionFragment;
...
export interface ICircleMessageTransmitter extends BaseContract {
    ...
    functions: {
        receiveMessage(_message: BytesLike, _attestation: BytesLike, overrides?: Overrides & {
    ...
    usedNonces(_nonceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        receiveMessage(_message: BytesLike, _attestation: BytesLike, overrides?: CallOverrides): Promise<boolean>;
        usedNonces(_nonceId: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
    estimateGas: {
...
//# sourceMappingURL=ICircleMessageTransmitter.d.ts.map