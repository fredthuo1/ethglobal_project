...
class LiquidityLayerApp extends HyperlaneApp_1.HyperlaneApp {
    ...
    async attemptPortalTransferCompletion(message) {
        ...
        try {
            await this.multiProvider.handleTx(message.destination, destinationPortalAdapter.completeTransfer(utils_1.utils.ensure0x(Buffer.from(vaa.vaaBytes, 'base64').toString('hex'))));
        }
        catch (error) {
