...
describe('InterchainAccounts', async () => {
    ...
    before(async () => {
        ...
        coreApp = await new TestCoreDeployer_1.TestCoreDeployer(multiProvider).deployApp();
        config = await (0, testUtils_1.deployTestIgpsAndGetRouterConfig)(multiProvider, signer.address, coreApp.contractsMap);
    });
    beforeEach(async () => {
