...
export declare function moduleCanCertainlyVerify(destModule: types.Address | IsmConfig, multiProvider: MultiProvider, origin: ChainName, destination: ChainName): Promise<boolean>;
export declare function moduleMatchesConfig(chain: ChainName, moduleAddress: types.Address, config: IsmConfig, multiProvider: MultiProvider, contracts: HyperlaneContracts<IsmFactoryFactories>, origin?: ChainName): Promise<boolean>;
