...
export interface HypERC20CollateralInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "balanceOf" | "destinationGas" | "domains" | "enrollRemoteRouter" | "enrollRemoteRouters" | "handle" | "initialize" | "interchainGasPaymaster" | "interchainSecurityModule" | "mailbox" | "owner" | "quoteGasPayment" | "renounceOwnership" | "routers" | "setDestinationGas" | "setInterchainGasPaymaster" | "setInterchainSecurityModule" | "setMailbox" | "transferOwnership" | "transferRemote" | "wrappedToken"): FunctionFragment;
